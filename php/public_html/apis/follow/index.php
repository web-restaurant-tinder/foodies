...
<<<<<<< HEAD
	...
	if($method === "GET") {
		...
		if ($followFollowedProfileId !== null && $followProfileId !== null) {
			...
			$reply->data = Follow::getFollowByFollowProfileId($pdo, $_SESSION ["profile"]->getProfileId()->toString())->toArray();
		}
...
//            validateJwtHeader();
			...
			verifyXsrf();
			validateJwtHeader();
			$follow = Follow::getFollowByFollowProfileIdAndFollowFollowedProfileId($pdo, $requestObject->followFollowedProfileId, $_SESSION ["profile"]->getProfileId()->toString());
			if ($follow === null) {
